...
class UndirectedGraph:
    ...
    def dfs(self, v_start, v_end=None) -> []:
        ...
        while temp:
            ...
            if v not in reachable:
                ...
                if v == v_end:
                    return reachable
                new_verts = sorted(self.adj_list[v], reverse=True)
                for u in new_verts:
                    temp.append(u)
        return reachable
    ...
    def bfs(self, v_start, v_end=None) -> []:
        ...
        while temp:
            ...
            if v not in reachable:
                ...
                if v == v_end:
                    return reachable
                new_verts = sorted(self.adj_list[v])
                for u in new_verts:
                    temp.append(u)
        return reachable
    ...
    def has_cycle(self):
        ...
        for v in self.adj_list:
            if v not in visited:
                if self.rec_has_cycle(v, visited, None):
                    return True
        return False

    def rec_has_cycle(self, v, visited, parent):
        visited.append(v)
        for u in self.adj_list[v]:
            if u not in visited:
                if self.rec_has_cycle(u, visited, v):
                    return True
            elif parent and parent != u:
                return True
        return False
